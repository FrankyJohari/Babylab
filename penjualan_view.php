...
$finalid = $_GET['id'];
$brg=mysqli_query($connect,"select * from penjualan_detail where trxid='$finalid' ");
  
$master=mysqli_fetch_array(mysqli_query($connect,"select * from penjualan where penid='$finalid'"));
...
<!-- <form> -->
    ...
    <div class="container">
        <table class="table-borderless" style="border-collapse: collapse; width: 100%"> 
          <tr>
            ...
            <td colspan="4">
              <label><?php echo $master['customer']?> </label>  
              </td>
        </tr>
          <tr>
                <td>
            ...
            <td colspan="4">
              <label><?php echo $master['tglpen']?> </label>  
              </td>
        </tr>
        </div>
    </table>
    ...
    <div class="table-responsive">
      ...
      <thead>
          ...
          <?php
          $total=mysqli_fetch_array(mysqli_query($connect,"select sum(subtotal) as total from penjualan_detail where trxid='$finalid'"));
...
<div class="card-footer">
	...
	<a href="index.php?page=list_penjualan"><button type="button" class="btn btn-secondary btn-lg ">Back</button></a>
