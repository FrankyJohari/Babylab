...
<div class="card">
 ...
 <div class="table-responsive">
        <table class="table table-hover" id="laporan_labarugi">
...
$("#laporan_labarugi").load("support/laporan_func.php","op=labarugi");
...
$("#bulan").change(function(){
        ...
        var tahun= $("#tahun").val();
            ...
            success:function(msg){
                $("#laporan_labarugi").load("support/laporan_func.php","op=labarugi_history&bulan="+bulan+"&tahun="+tahun);
